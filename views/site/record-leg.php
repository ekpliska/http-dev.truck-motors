...
$this->title = 'Запись на сервис - Юридическое лицo | ' . Yii::$app->params['site_title']; 
...
$this->params['breadcrumbs'][] = 'Юридическое лицo';

/* 
 * Форма - Запись на СТО (Юридическое лицо)
 */
?>
        ...
        <div class="row">
            ...
            <?php if (Yii::$app->session->hasFlash('error')) : ?>
                <div class="alert alert-danger" role="alert">
                    <strong>
                        test<?= Yii::$app->session->getFlash('error', false); ?>
                    </strong>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>                     
            ...
            <div class="col-sm-6 col-xs-12">
                ...
                <?php /*= $form->field($model, 'records_townId')
                        ->dropdownList(Towns::find()->select(['towns_name', 'towns_id'])
                            ->indexBy('towns_id')
                            ->column(),
                ...
                */ ?>
                ...
                <?= $form->field($model, 'records_nameCompany')->input('text', ['placeholder' => $model->getAttributeLabel('records_nameCompany')])->label(false); ?>
